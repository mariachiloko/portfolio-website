...
- The environment also provisions a private S3 content bucket that GitHub Actions can read during deploy.
...
- Use the private content bucket output to publish local content into CI when you are ready for the live site to use it.
